...
public class FractionDriver{
    ...
    public static void main (String [] args){
        ...
        System.out.println(Fraction.add(half, third));
         System.out.println(Fraction.sub(half, third));
         
         System.out.println(Fraction.mult(half, third));
         System.out.println(Fraction.div(half, third));
